...
module.exports = {
  ...
  'colors': {
    ...
    'color-orange-mid': '#ff9d00',
    'color-orange': '#ff6100',
    'color-orange-dark': '#bc3b09',
    'color-orange-vroom': '#F6901E',
    'color-purple': '#7735b2',
  ...
  'logos': [
    ...
    'icon-vroom-logo-black',
    'icon-vroom-logo-white',
    'icon-vroom-logo-orange',
    'icon-vroom-logo-black-ar',
    'icon-vroom-logo-white-ar',
    'icon-vroom-logo-orange-ar',
    'icon-vroom-logo-black-bn',
    'icon-vroom-logo-white-bn',
    'icon-vroom-logo-orange-bn',
    'icon-vroom-logo-black-es',
    'icon-vroom-logo-white-es',
    'icon-vroom-logo-orange-es',
    'icon-vroom-logo-black-fr',
    'icon-vroom-logo-white-fr',
    'icon-vroom-logo-orange-fr',
    'icon-vroom-logo-black-ht',
    'icon-vroom-logo-white-ht',
    'icon-vroom-logo-orange-ht',
    'icon-vroom-logo-black-ko',
    'icon-vroom-logo-white-ko',
    'icon-vroom-logo-orange-ko',
    'icon-vroom-logo-black-pl',
    'icon-vroom-logo-white-pl',
    'icon-vroom-logo-orange-pl',
    'icon-vroom-logo-black-ru',
    'icon-vroom-logo-white-ru',
    'icon-vroom-logo-orange-ru',
    'icon-vroom-logo-black-ur',
    'icon-vroom-logo-white-ur',
    'icon-vroom-logo-orange-ur',
    'icon-vroom-logo-black-zh-hant',
    'icon-vroom-logo-white-zh-hant',
    'icon-vroom-logo-orange-zh-hant',
  ]
};